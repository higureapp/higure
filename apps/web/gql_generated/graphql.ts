...
export type SignUpMutation = { __typename?: 'Mutation', signUp: { __typename?: 'SignUpResponse', access_token: string, refresh_token: string, user: { __typename?: 'User', id: string, email: string, firstname: string, createdAt: any } } };


export const SignUpDocument = gql`
    mutation SignUp {
  signUp(
    signUpInput: {email: "user@example.com", password: "Password123!", firstname: "John", lastname: "Doe"}
  ) {
    access_token
    refresh_token
    user {
