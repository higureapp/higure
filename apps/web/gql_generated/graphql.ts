...
export type CompleteHabitMutation = {
    __typename?: 'Mutation'
    completeHabit: {
        __typename?: 'HabitCompletion'
        id: string
        completedAt: any
        notes?: string | null
        habit: { __typename?: 'Habit'; id: string; streakCount: number }
    }
}
...
export function getSdk(
    ...
    return {
        CompleteHabit(
            variables: CompleteHabitMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<CompleteHabitMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CompleteHabitMutation>({
                        document: CompleteHabitDocument,
                        variables,
                        requestHeaders: {
                            ...requestHeaders,
                            ...wrappedRequestHeaders,
        ...
        CreateHabit(
            variables: CreateHabitMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<CreateHabitMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CreateHabitMutation>({
                        document: CreateHabitDocument,
                        variables,
                        requestHeaders: {
                            ...requestHeaders,
                            ...wrappedRequestHeaders,
        ...
        GetHabitStats(
            variables: GetHabitStatsQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetHabitStatsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetHabitStatsQuery>({
                        document: GetHabitStatsDocument,
                        variables,
                        requestHeaders: {
                            ...requestHeaders,
                            ...wrappedRequestHeaders,
        ...
        GetHabits(
            ...
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetHabitsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetHabitsQuery>({
                        document: GetHabitsDocument,
                        variables,
                        requestHeaders: {
                            ...requestHeaders,
                            ...wrappedRequestHeaders,
