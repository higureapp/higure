...
export type ReflectionFieldsFragment = { __typename?: 'ReflectionModel', id: string, journalPageId: string, type: ReflectionType, content: string, keyInsights: Array<string>, suggestedQuestion: string, generatedAt: any, modelVersion: string };
...
export type CreateJournalPageMutation = { __typename?: 'Mutation', createJournalPage: { __typename?: 'Journal', id: string, date: any, content: string, mood: number, tags: Array<{ __typename?: 'JournalTag', id: string, name: string, color?: string | null }> } };
...
export type CreateReflectionMutation = { __typename?: 'Mutation', createReflection: { __typename?: 'ReflectionModel', id: string, journalPageId: string, type: ReflectionType, content: string, keyInsights: Array<string>, suggestedQuestion: string, generatedAt: any, modelVersion: string } };
...
export type DeleteJournalPageMutation = { __typename?: 'Mutation', deleteJournalPage: boolean };
...
export type RestoreJournalPageMutation = { __typename?: 'Mutation', restoreJournalPage: { __typename?: 'Journal', id: string, isActive: boolean } };
...
export type SoftDeleteJournalPageMutation = { __typename?: 'Mutation', softDeleteJournalPage: { __typename?: 'Journal', id: string, isActive: boolean } };
...
export type UpdateJournalPageMutation = { __typename?: 'Mutation', updateJournalPage: { __typename?: 'Journal', id: string, date: any, content: string, mood: number, lastModified: any, tags: Array<{ __typename?: 'JournalTag', name: string, color?: string | null }> } };
...
export type UpdateSettingsMutation = { __typename?: 'Mutation', updateSettings: { __typename?: 'User', id: string, firstname: string, lastname: string, email: string, phone?: string | null, timezone: string, locale: string, language: LanguageEnum, theme: Theme, emailVerified: boolean, phoneVerified: boolean, lastLoginAt?: any | null, createdAt: any, updatedAt: any, avatarUrl?: string | null } };

export type AvailableReflectionTypesQueryVariables = Exact<{ [key: string]: never; }>;


export type AvailableReflectionTypesQuery = { __typename?: 'Query', availableReflectionTypes: Array<{ __typename?: 'ReflectionTypeInfo', type: ReflectionType, label: string, description: string, icon: string }> };
...
export type GetJournalPagesQuery = { __typename?: 'Query', journalPages: { __typename?: 'GetJournalPagesOutput', totalCount: number, hasMore: boolean, currentPage: number, totalPages: number, pages: Array<{ __typename?: 'Journal', id: string, date: any, location?: string | null, mood: number, content: string, tags: Array<{ __typename?: 'JournalTag', name: string, color?: string | null }>, metrics?: { __typename?: 'JournalMetrics', wordCount: number, emotionalValence: number } | null }> } };

export type GetMeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, firstname: string, lastname: string, email: string, phone?: string | null, timezone: string, locale: string, language: LanguageEnum, theme: Theme, emailVerified: boolean, phoneVerified: boolean, lastLoginAt?: any | null, createdAt: any, updatedAt: any, avatarUrl?: string | null } };
 ...
 * });
 */
export function useCreateAnalysisMutation(options: VueApolloComposable.UseMutationOptions<CreateAnalysisMutation, CreateAnalysisMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateAnalysisMutation, CreateAnalysisMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<CreateAnalysisMutation, CreateAnalysisMutationVariables>(CreateAnalysisDocument, options);
}
 ...
 * });
 */
export function useCreateJournalPageMutation(options: VueApolloComposable.UseMutationOptions<CreateJournalPageMutation, CreateJournalPageMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateJournalPageMutation, CreateJournalPageMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<CreateJournalPageMutation, CreateJournalPageMutationVariables>(CreateJournalPageDocument, options);
}
 ...
 * });
 */
export function useCreateReflectionMutation(options: VueApolloComposable.UseMutationOptions<CreateReflectionMutation, CreateReflectionMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<CreateReflectionMutation, CreateReflectionMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<CreateReflectionMutation, CreateReflectionMutationVariables>(CreateReflectionDocument, options);
}
export type CreateReflectionMutationCompositionFunctionResult = VueApolloComposable.UseMutationReturn<CreateReflectionMutation, CreateReflectionMutationVariables>;
 ...
 * });
 */
export function useDeleteAnalysisMutation(options: VueApolloComposable.UseMutationOptions<DeleteAnalysisMutation, DeleteAnalysisMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<DeleteAnalysisMutation, DeleteAnalysisMutationVariables>> = {}) {
 ...
 * });
 */
export function useDeleteJournalPageMutation(options: VueApolloComposable.UseMutationOptions<DeleteJournalPageMutation, DeleteJournalPageMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<DeleteJournalPageMutation, DeleteJournalPageMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<DeleteJournalPageMutation, DeleteJournalPageMutationVariables>(DeleteJournalPageDocument, options);
}
 ...
 * });
 */
export function useRegenerateAnalysisMutation(options: VueApolloComposable.UseMutationOptions<RegenerateAnalysisMutation, RegenerateAnalysisMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<RegenerateAnalysisMutation, RegenerateAnalysisMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<RegenerateAnalysisMutation, RegenerateAnalysisMutationVariables>(RegenerateAnalysisDocument, options);
}
 ...
 * });
 */
export function useRestoreJournalPageMutation(options: VueApolloComposable.UseMutationOptions<RestoreJournalPageMutation, RestoreJournalPageMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<RestoreJournalPageMutation, RestoreJournalPageMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<RestoreJournalPageMutation, RestoreJournalPageMutationVariables>(RestoreJournalPageDocument, options);
}
 ...
 * });
 */
export function useSoftDeleteJournalPageMutation(options: VueApolloComposable.UseMutationOptions<SoftDeleteJournalPageMutation, SoftDeleteJournalPageMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<SoftDeleteJournalPageMutation, SoftDeleteJournalPageMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<SoftDeleteJournalPageMutation, SoftDeleteJournalPageMutationVariables>(SoftDeleteJournalPageDocument, options);
}
 ...
 * });
 */
export function useUpdateJournalPageMutation(options: VueApolloComposable.UseMutationOptions<UpdateJournalPageMutation, UpdateJournalPageMutationVariables> | ReactiveFunction<VueApolloComposable.UseMutationOptions<UpdateJournalPageMutation, UpdateJournalPageMutationVariables>> = {}) {
  return VueApolloComposable.useMutation<UpdateJournalPageMutation, UpdateJournalPageMutationVariables>(UpdateJournalPageDocument, options);
}
...
export const UpdateSettingsDocument = gql`
    mutation UpdateSettings($input: UpdateUserInput!) {
 ...
 */
export function useAvailableReflectionTypesQuery(options: VueApolloComposable.UseQueryOptions<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>(AvailableReflectionTypesDocument, {}, options);
}
export function useAvailableReflectionTypesLazyQuery(options: VueApolloComposable.UseQueryOptions<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>(AvailableReflectionTypesDocument, {}, options);
}
export type AvailableReflectionTypesQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<AvailableReflectionTypesQuery, AvailableReflectionTypesQueryVariables>;
 ...
 * });
 */
export function useGetAnalysisByJournalPageQuery(variables: GetAnalysisByJournalPageQueryVariables | VueCompositionApi.Ref<GetAnalysisByJournalPageQueryVariables> | ReactiveFunction<GetAnalysisByJournalPageQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables>(GetAnalysisByJournalPageDocument, variables, options);
}
export function useGetAnalysisByJournalPageLazyQuery(variables?: GetAnalysisByJournalPageQueryVariables | VueCompositionApi.Ref<GetAnalysisByJournalPageQueryVariables> | ReactiveFunction<GetAnalysisByJournalPageQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GetAnalysisByJournalPageQuery, GetAnalysisByJournalPageQueryVariables>(GetAnalysisByJournalPageDocument, variables, options);
}
...
export function useGetJournalPageQuery(variables: GetJournalPageQueryVariables | VueCompositionApi.Ref<GetJournalPageQueryVariables> | ReactiveFunction<GetJournalPageQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetJournalPageQuery, GetJournalPageQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetJournalPageQuery, GetJournalPageQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetJournalPageQuery, GetJournalPageQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetJournalPageQuery, GetJournalPageQueryVariables>(GetJournalPageDocument, variables, options);
}
export function useGetJournalPageLazyQuery(variables?: GetJournalPageQueryVariables | VueCompositionApi.Ref<GetJournalPageQueryVariables> | ReactiveFunction<GetJournalPageQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetJournalPageQuery, GetJournalPageQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetJournalPageQuery, GetJournalPageQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetJournalPageQuery, GetJournalPageQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GetJournalPageQuery, GetJournalPageQueryVariables>(GetJournalPageDocument, variables, options);
}
...
export const GetJournalPagesDocument = gql`
    query GetJournalPages($filters: JournalPageFilters, $pagination: JournalPaginationInput) {
 ...
 * });
 */
export function useGetJournalPagesQuery(variables: GetJournalPagesQueryVariables | VueCompositionApi.Ref<GetJournalPagesQueryVariables> | ReactiveFunction<GetJournalPagesQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<GetJournalPagesQuery, GetJournalPagesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetJournalPagesQuery, GetJournalPagesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetJournalPagesQuery, GetJournalPagesQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetJournalPagesQuery, GetJournalPagesQueryVariables>(GetJournalPagesDocument, variables, options);
}
export function useGetJournalPagesLazyQuery(variables: GetJournalPagesQueryVariables | VueCompositionApi.Ref<GetJournalPagesQueryVariables> | ReactiveFunction<GetJournalPagesQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<GetJournalPagesQuery, GetJournalPagesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetJournalPagesQuery, GetJournalPagesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetJournalPagesQuery, GetJournalPagesQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GetJournalPagesQuery, GetJournalPagesQueryVariables>(GetJournalPagesDocument, variables, options);
}
 ...
 * });
 */
export function useGetReflectionQuery(variables: GetReflectionQueryVariables | VueCompositionApi.Ref<GetReflectionQueryVariables> | ReactiveFunction<GetReflectionQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetReflectionQuery, GetReflectionQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetReflectionQuery, GetReflectionQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetReflectionQuery, GetReflectionQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetReflectionQuery, GetReflectionQueryVariables>(GetReflectionDocument, variables, options);
}
export function useGetReflectionLazyQuery(variables?: GetReflectionQueryVariables | VueCompositionApi.Ref<GetReflectionQueryVariables> | ReactiveFunction<GetReflectionQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetReflectionQuery, GetReflectionQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetReflectionQuery, GetReflectionQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetReflectionQuery, GetReflectionQueryVariables>> = {}) {
