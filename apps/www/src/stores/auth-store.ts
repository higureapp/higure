...
import { useGetMeQuery, useSignInMutation, useSignUpMutation } from '../../gql_generated/graphql';
...
export const useAuthStore = defineStore('auth', () => {
    ...
    return { token, me, isLoading, isLoggedIn, login, register, logout, refetchMe }
})